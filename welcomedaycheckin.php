...
<?php include 'nav.php'; ?>
<br> <br> <br>
<h2 align="center">This is the checkin for the Welcome Day on Saturday/Sunday April 5/6th! <br>Choose your name and submit!</h2>
<div class="well col-lg-6 col-lg-offset-3">
    <form name="wd" class="horizontal-form" action="processwelcomedaycheckin.php" method="POST">
        <h3>Name: </h3>
        ...
        <div class="form-group">
            <select name="coverage" class="form-control" id="coverage">
                ...
                $res = $mysqli->query("SELECT Name FROM `GuideList` WHERE `WelcomeDayAttendance`=0 ORDER BY Name ASC");
