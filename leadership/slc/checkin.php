...
if (strpos($guidename, '(C)') !== false) {
    ...
    } else if ($support != "Select...") {
        $answer = fwrite($file, $date . " " . $newtime  . ": " . $$support . " assisted on a tour!\n");
        $res = $mysqli->query("UPDATE Minglers SET TourSupport=TourSupport + 1 WHERE Name='$support'");
